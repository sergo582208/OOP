public class Gryfindor extends Hogwarts {
    private int nobility;
    private int honour;
    private int courage;

    public Gryfindor(String fullName, int powerOfMagic, int transgressionDistance, int nobility, int honour, int courage) {
    ...
    public static void compare(Gryfindor student1, Gryfindor student2){
